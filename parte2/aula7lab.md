...
8. Escreva uma função calcular_pagamento que aceita os parâmetros nomeados horas_trabalhadas e taxa_hora e retorna o pagamento total.

9. Crie uma função que retorne o maior número dentre 3 elementos.
...
## Casos de Testes para as Funções
